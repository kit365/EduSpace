          ...
          <div className="flex items-center gap-4">
            ...
            {isAuthenticated ? (
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-red-500 text-white rounded-xl font-bold text-sm hover:bg-red-600 transition-all shadow-lg shadow-red-200 hover:shadow-red-300"
              >
