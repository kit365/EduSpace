...
public class KafkaSagaListenerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> sagaAssignStaffKafkaListenerContainerFactory() {
        ...
        // Retry when handler throws (e.g. conversation not visible yet); aligns with StaffAssignmentSagaHandler.
        factory.setCommonErrorHandler(new DefaultErrorHandler(new FixedBackOff(500L, 10L)));
        return factory;
    }
}
