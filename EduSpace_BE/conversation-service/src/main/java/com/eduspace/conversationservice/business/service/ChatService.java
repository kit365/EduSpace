...
public interface ChatService {
    ...
    ConversationResponse claimConversation(String conversationId, String adminId);
 
    ConversationResponse transferConversation(String conversationId, String currentAdminId, String targetAdminId);
 
    void requeueConversation(String conversationId, String actorId);
