...
/**
 * Bộ quyền (template) cho Partner Portal — đặt tại /rental, không chỉ admin.
 * Manager: chỉ GET; Host: đầy đủ CRUD.
 */
@RestController
@RequestMapping(AccountPaths.BASE_PATH + AccountPaths.HOST + "/permission-templates")
@RequiredArgsConstructor
public class HostPermissionTemplateController {
