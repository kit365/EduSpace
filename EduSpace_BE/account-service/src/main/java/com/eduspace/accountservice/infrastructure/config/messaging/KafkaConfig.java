...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "com.eduspace.accountservice.model.event");
    ...
    @Bean
    public ConsumerFactory<String, String> sagaJsonStringConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
        config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        // Dedicated group: avoid two consumers sharing default groupId with different deserializers
        config.put(ConsumerConfig.GROUP_ID_CONFIG, groupId + "-assign-staff");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
