package com.eduspace.accountservice.common.enums.banks;
...
/** Vietnam banks (ported from TeddyPet). */
public enum VietnamBankEnum {
    ...
    public static Optional<VietnamBankEnum> fromCode(String code) {
        ...
        Optional<VietnamBankEnum> byShort =
                valuesList().stream().filter(b -> b.bankCode.equalsIgnoreCase(c)).findFirst();
